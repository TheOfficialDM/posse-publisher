...
var PossePublisherSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Quick start").setHeading();
    new import_obsidian.Setting(containerEl).setName("How to publish").setDesc("1. Enter your site URL. 2. Add one destination. 3. Run POSSE publish.");
    new import_obsidian.Setting(containerEl).setName("Your canonical site").setHeading();
    new import_obsidian.Setting(containerEl).setName("Canonical base URL").setDesc("Enter your site root URL. Published posts link back here as the canonical original.").addText(
    ...
    new import_obsidian.Setting(containerEl).setName("Start with one destination").setDesc("Custom API, Dev.to, Mastodon, and Bluesky are ready now.");
    this.plugin.settings.destinations.forEach((destination, index) => {
      ...
      new import_obsidian.Setting(destContainer).setName("Destination name").setDesc("Name shown in the picker and status messages").addText(
      ...
      new import_obsidian.Setting(destContainer).setName("Type").setDesc("Choose where this destination publishes").addDropdown(
      ...
      if (destType === "custom-api") {
        new import_obsidian.Setting(destContainer).setName("Site URL").setDesc("Enter your site base URL. Use https:// for live sites.").addText(
        ...
        new import_obsidian.Setting(destContainer).setName("API key").setDesc("Paste the PUBLISH_API_KEY from your site").addText((text) => {
        ...
        new import_obsidian.Setting(destContainer).setName("Access token").setDesc("Create a new app in Mastodon settings > development").addText((text) => {
        ...
        new import_obsidian.Setting(destContainer).setName("API notice").setDesc("Medium API was archived in March 2023 and may stop working.");
        ...
        new import_obsidian.Setting(destContainer).setName("Client secret").setDesc("From the same Reddit app").addText((text) => {
        ...
        new import_obsidian.Setting(destContainer).setName("Refresh token").setDesc("Paste the refresh token for this Reddit account").addText((text) => {
        ...
        new import_obsidian.Setting(destContainer).setName("Default subreddit").setDesc("Optional. Example: r/webdev").addText(
        ...
        new import_obsidian.Setting(destContainer).setName("Threads user ID").setDesc("Your numeric Threads user ID").addText(
        ...
        new import_obsidian.Setting(destContainer).setName("Access token").setDesc("Paste your long-lived Threads token").addText((text) => {
        ...
        new import_obsidian.Setting(destContainer).setName("Access token").setDesc("Paste a LinkedIn token with w_member_social scope").addText((text) => {
        ...
        new import_obsidian.Setting(destContainer).setName("Person identifier").setDesc("Paste your LinkedIn person ID").addText(
          (text) => text.setPlaceholder("LinkedIn person ID").setValue(destination.linkedinPersonUrn || "").onChange(async (value) => {
            this.plugin.settings.destinations[index].linkedinPersonUrn = value;
            await this.plugin.saveSettings();
          })
        );
      } else if (destType === "ecency") {
        new import_obsidian.Setting(destContainer).setName("Username").setDesc("Enter your ecency username without the @").addText(
        ...
        new import_obsidian.Setting(destContainer).setName("Posting key").setDesc("Paste your ecency posting key").addText((text) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Confirm before publishing").setDesc("Review the title, slug, status, and type before publishing").addToggle(
    ...
    new import_obsidian.Setting(containerEl).setName("Auto-publish on save").setDesc("Re-publish automatically on save when the note status is published.").addToggle(
...
//# sourceMappingURL=data:application/json;base64,
