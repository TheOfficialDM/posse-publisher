  ...
  display() {
    ...
    this.plugin.settings.destinations.forEach((destination, index) => {
      ...
      if (destType === "custom-api") {
        ...
        new import_obsidian.Setting(destContainer).setName("Refresh token").setDesc("OAuth refresh token for your Reddit account").addText((text) => {
        ...
        new import_obsidian.Setting(destContainer).setName("Access token").setDesc("OAuth bearer token with w_member_social scope").addText((text) => {
        ...
        new import_obsidian.Setting(destContainer).setName("Person URN").setDesc("Your LinkedIn member URN").addText(
